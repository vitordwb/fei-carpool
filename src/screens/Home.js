...
class Home extends React.Component {
  ...
  render() {
    ...
    const { type, selectType, showMap, userLat, userLon, feiLat, feiLon } =
      this.state;
    console.log(`default lat: ${userLat}`);
    console.log(`default lon: ${userLon}`);
    console.log(`fei lat: ${feiLat}`);
    console.log(`fei lon: ${feiLon}`);
